(function($){
    ...
    */
    ...
    $.RedinkCookie = function(options) {
        var res;
        if ($.RedinkCookie.check() == true) {
            //cookie exist
            res = "cookie exists"
        } else {
            //create new cookie
           defaultSettings = $.extend({}, defaultSettings, options);
           var d = JSON.stringify(defaultSettings);
           console.log("---> "+d);
           document.cookie = d;
           res = "cookie created";
        }
    ...
    $.RedinkCookie.check = function() {
        ...
        console.log("co "+co+" > "+document.cookie);
        for (var i = 0; i < co.length; i++) {
            console.log("> "+co[i]);
        }*/
        console.log("search: "+document.cookie.match(/redink/));
        if (document.cookie.search(/redink/) < 0) {
            // no cookie
